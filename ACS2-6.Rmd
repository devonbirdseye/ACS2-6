...
```
```{r}
Redox.WithNons2.fixed.acs <- Redox.WithNons2[,c(34,45:47)]
Redox.WithNons2.fixed.b73 <- Redox.WithNons2[,c(34,48:50)]
Redox.WithNons2.variable.acs <- Redox.WithNons2[,c(34,51:53)]
Redox.WithNons2.variable.b73 <- Redox.WithNons2[,c(34,54:56)]
```
```{r}
...
colnames(Redox.WithNons2.fixed.m) <- c("Accession", "variable", "acs", "B73")
colnames(Redox.WithNons2.variable.m) <- c("Accession", "variable", "acs", "B73")
```
```{r}
ggplot(data=Redox.WithNons2.variable.m, mapping = aes(x=B73, y = acs, color=variable))+
  geom_point()+
  xlim(0,7.5)+
  ylim(0,7.5)
```
